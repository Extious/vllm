...
def load_user_data(user_id: str) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
    ...
    Returns:
        Tuple containing (history_data, candidate_data) where each is a list of item dictionaries

    Raises:
        FileNotFoundError: If the user directory or required files don't exist
    """
